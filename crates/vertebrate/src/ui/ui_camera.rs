...
use crate::{body::Body, world::{World, WorldPlugin}};
...
fn startup_camera(
    ...
    for y in 0..height {
        wall(&mut form, (0., y as f32), (0., y as f32 + 1.), 0.1);

        wall(&mut form, (width as f32, y as f32), (width as f32, y as f32 + 1.), 0.3);
    }

    for x in 0..width {
        wall(&mut form, (x as f32, 0.), (x as f32 + 1., 0.), 0.7);

        wall(&mut form, (x as f32, height as f32), (x as f32 + 1., height as f32), 0.9);
